...
namespace WPEPUBReader1.EPUB.Utils
{
    public sealed class ZipUtils
    {
        ...
        /// <returns></returns>
        public static IAsyncAction UnZipFileAsync(ZipArchive zipFile, StorageFolder destinationFolder)
        {
            return UnZipFileHelper(zipFile, destinationFolder).AsAsyncAction();
        }

        private static async Task UnZipFileHelper(ZipArchive zipFile, StorageFolder destinationFolder)
        {
